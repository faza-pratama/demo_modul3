...
import java.text.NumberFormat; // Untuk format mata uang Rupiah
...
public class NotaPesanan {
    ...
    public void cetakNota() {
        // Helper untuk format Rupiah (agar unik dari yang lain)
        ...
        // Gunakan autocomplete IDE Anda saat mengetik 'item.'
